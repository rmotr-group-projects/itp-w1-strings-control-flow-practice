...
"""
    ...
    return(board.format(first_row[0],first_row[1],first_row[2],second_row[0],second_row[1],second_row[2],third_row[0],third_row[1],third_row[2]))

print format_tic_tac_toe_board('XOX','OXO','OOX')
