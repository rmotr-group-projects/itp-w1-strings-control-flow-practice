...
def format_tic_tac_toe_board(first_row, second_row, third_row):
    ...
    return row.format(first_row[0],first_row[1],first_row[2]) + \
        dashes + row.format(second_row[0],second_row[1],second_row[2]) \
        + dashes + row.format(third_row[0],third_row[1],third_row[2])
